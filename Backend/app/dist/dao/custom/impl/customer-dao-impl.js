...
var CustomerDAOImpl = /** @class */ (function () {
    ...
    CustomerDAOImpl.prototype.save = function (entity) {
        ...
        return new Promise(function (resolve, reject) {
            _this.connection.query("INSERT INTO Customer VALUES ('" + entity.id + "','" + entity.name + "','" + entity.address + "','" + entity.email + "')", function (err, results) {
                if (err) {
                    reject(err);
                }
                else {
    ...
    CustomerDAOImpl.prototype.update = function (entity) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.connection.query("UPDATE Customer SET name = '" + entity.name + "', address ='" + entity.address + "', email ='" + entity.email + "' WHERE id='" + entity.id + "'", function (err, results) {
                if (err) {
                    reject(err);
                }
                else {
